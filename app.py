...
with st.sidebar:
    ...
    <div style='text-align:center; padding: 1rem 0 1.5rem;'>
      <div style='font-family:Bebas Neue,sans-serif; font-size:1.7rem; letter-spacing:3px; color:#00ff88;'>🦠 INVISIBLE</div>
      <div style='font-family:Bebas Neue,sans-serif; font-size:1.7rem; letter-spacing:3px;'> ENEMIES</div>
      <div style='font-family:Space Mono,monospace; font-size:.65rem; color:#7d8590; letter-spacing:2px;'>FOOD MICROBIOLOGY</div>
      
      <div style='margin-top: 15px; padding: 5px; border: 1px solid #21262d; border-radius: 5px; background: #161b22;'>
        <div style='font-family:Space Mono,monospace; font-size:.7rem; color:#e6edf3;'>About the Developer</div>
        <div style='font-family:Space Mono,monospace; font-size:1.50rem; color:#00ff88;'>Name: Prabrisha Basu</div>
        <div style='font-family:Space Mono,monospace; font-size:1.50rem; color:#00ff88;'>Roll No.: 0649</div>
      </div>
      </div>
    """, unsafe_allow_html=True)
    page = st.radio(
